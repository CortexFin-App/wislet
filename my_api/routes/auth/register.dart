...
Future<Response> onRequest(RequestContext context) async {
  ...
  try {
    ...
    if (user != null && response.session == null) {
      ...
      return Response.json(body: {'status': 'session_created', 'access_token': response.session!.accessToken, 'refresh_token': response.session!.refreshToken, 'user_id': user!.id});
    } else {
