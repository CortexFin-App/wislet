...
class _AddEditSubscriptionScreenState extends State<AddEditSubscriptionScreen> {
  ...
  void initState() {
    ...
    if (_isEditing) {
      ...
      _amountController = TextEditingController(text: sub.amount.toStringAsFixed(2).replaceAll('.', ','));
        ...
        child: ListView(
          ...
          children: <Widget>[
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                          ...
                          prefixIcon: Padding(
                            ...
                            child: Text(_selectedCurrency?.symbol ?? '', textAlign: TextAlign.center, style: TextStyle(fontSize: 16, color: Theme.of(context).colorScheme.onSurfaceVariant)),
                          )
                      ),
              ...
              DropdownButtonFormField<BillingCycle>(
                  ...
                  items: BillingCycle.values.map((c) => DropdownMenuItem(value: c, child: Text(billingCycleToString(c, context)))).toList(),
                  onChanged: (val) {
                      if (val != null) {
                          setState(() {
              ...
              ListTile(
                  ...
                  title: const Text('Дата наступного платежу'),
              ...
              DropdownButtonFormField<int>(
                  ...
                  decoration: const InputDecoration(labelText: 'Нагадувати', prefixIcon: Icon(Icons.notifications_active_outlined)),
              ...
              const SizedBox(height: 24),
              TextFormField(controller: _paymentMethodController, decoration: const InputDecoration(labelText: 'Метод оплати (опціонально)', prefixIcon: Icon(Icons.credit_card_outlined))),
              const SizedBox(height: 16),
              TextFormField(controller: _websiteController, decoration: const InputDecoration(labelText: 'Веб-сайт (опціонально)', prefixIcon: Icon(Icons.public_outlined)), keyboardType: TextInputType.url),
              const SizedBox(height: 16),
              TextFormField(controller: _notesController, decoration: const InputDecoration(labelText: 'Нотатки (опціонально)', prefixIcon: Icon(Icons.notes_outlined)), maxLines: 3),
              const SizedBox(height: 16),
              SwitchListTile(
