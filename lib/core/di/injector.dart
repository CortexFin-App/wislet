...
import 'package:sage_wallet_reborn/data/repositories/local/local_asset_repository_impl.dart';
...
import 'package:sage_wallet_reborn/data/repositories/local/local_liability_repository_impl.dart';
...
import 'package:sage_wallet_reborn/data/repositories/supabase/supabase_asset_repository_impl.dart';
import 'package:sage_wallet_reborn/data/repositories/supabase/supabase_budget_repository_impl.dart';
import 'package:sage_wallet_reborn/data/repositories/supabase/supabase_category_repository_impl.dart';
import 'package:sage_wallet_reborn/data/repositories/supabase/supabase_debt_loan_repository_impl.dart';
import 'package:sage_wallet_reborn/data/repositories/supabase/supabase_goal_repository_impl.dart';
import 'package:sage_wallet_reborn/data/repositories/supabase/supabase_invitation_repository_impl.dart';
import 'package:sage_wallet_reborn/data/repositories/supabase/supabase_liability_repository_impl.dart';
import 'package:sage_wallet_reborn/data/repositories/supabase/supabase_notification_repository_impl.dart';
import 'package:sage_wallet_reborn/data/repositories/supabase/supabase_plan_repository_impl.dart';
import 'package:sage_wallet_reborn/data/repositories/supabase/supabase_repeating_transaction_repository_impl.dart';
import 'package:sage_wallet_reborn/data/repositories/supabase/supabase_subscription_repository_impl.dart';
import 'package:sage_wallet_reborn/data/repositories/supabase/supabase_transaction_repository_impl.dart';
import 'package:sage_wallet_reborn/data/repositories/supabase/supabase_user_repository_impl.dart';
import 'package:sage_wallet_reborn/data/repositories/supabase/supabase_wallet_repository_impl.dart';
